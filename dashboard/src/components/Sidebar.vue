...
import { ref } from 'vue'
import { LayoutDashboard, Users, FileText, Settings, BarChart2, Radio, ChevronRight, Menu, Clock, Building2, Banknote, ShieldAlert } from 'lucide-vue-next'
...
const navigation = [
  ...
  { name: 'الرواتب', to: '/payroll', routeName: 'payroll', icon: Banknote },
  { name: 'الإذاعة', to: '/broadcast', routeName: 'broadcast', icon: Radio },
  { name: 'سجل النظام', to: '/logs', routeName: 'logs', icon: ShieldAlert },
